...
def getOpts(expt_name):
    ...
    opt['short_instructions_file'] = 'templates/adherence/short_instructions_identity.html'
    opt['consent_file'] = 'templates/adherence/consent_basic.html'
